                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="disp" class="active">View</a></li>
                            <li class="scroll-to-section"><a href="list" class="">Update</a></li>
                        ...
                        <div style="display: flex; justify-content: center; align-items: center;">
                            <table style="border-style: solid; border-color:#3c3c3c;">
                                <tr style="background-color: grey; color: white;">
                                    ...
                                    <th style="padding: 30px">Student Name</th>
                                    <th style="padding: 30px">Supervisor</th>
                                    <th style="padding: 30px">First Examiner</th>
                                    <th style="padding: 30px">Second Examiner</th>
                                ...
                                <td> {{$proj['studName']}} </td> 
                                <td> {{$proj['svName']}} </td> 
                                <td> {{$proj['examiner1']}} </td>
                                <td> {{$proj['examiner2']}} </td>
                                <td> {{$proj['progress']}} </td> 
                                <td> {{$proj['status']}} </td> 
